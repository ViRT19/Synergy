package Lesson10;
// Взял чужую программу. Есть пока непонятные конструкции: <джейнерики>, @ собачка, super. Есть, что поизучать.
// Добавил окончание игры, когда змейка врезается в стенку.
import java.awt.*;
